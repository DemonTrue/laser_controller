...
#define MAX_CONTINIOUS_PULSE_TIME		600000 	// Максимальная длительность эксперимента 10 минут

#define DEADTIME_TICKS					100		// Дэдтайм: число тиков относительно частоты тактирования APB2. При 100МГц 1 тик = 10нс
